                                ...
                                <div class="account-settings">
                                    <div class="user-profile">
                                        <div class="user-avatar">
                                            <img src="https://cdn-icons-png.flaticon.com/512/6662/6662916.png" alt="User picture">
                                        </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="website">Change Image</label>
                                            <input type="url" class="form-control" id="linkImage" name="linkImage" placeholder="Image url">
                                        </div>
                                    </div>
                                </div>
                                <div class="row gutters">
