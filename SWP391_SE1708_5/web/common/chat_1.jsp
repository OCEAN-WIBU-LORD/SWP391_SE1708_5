            ...
            <div class="row justify-content-center h-100">
                <div class="col-md-4 col-xl-3 chat"><div class="card mb-sm-3 mb-md-0 contacts_card">
                        ...
                        <div class="card-body contacts_body">
                            <ui class="contacts">
                                <a href="chat2?user_id=${user.user_id}" class="img" >
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="${user.link_image}" class="rounded-circle user_img">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                                <span>${user.user_id}</span>
                                                <p>${user.user_id} is online</p>
                                            </div>
                                        </div>
                                    </li>
                                </a>
                                ...
                                <c:forEach items="${messageList}" var = "m">
                                    <c:forEach items="${userlist}" var = "p">
                                        <c:if test="${p.user_id eq m.user_id}">
                                ...
                                <c:forEach items="${userlist}" var = "p">
                                    <c:forEach items="${userIds1}" var = "q">
                                        <c:if test="${q eq p.user_id}">
                                            <a href="chat?user_id=${p.user_id}" class="img my-element" >
                                                <li onclick="activate()" id="button">
                                                    <div class="d-flex bd-highlight ">
                                                        ...
                                                        <div class="user_info">
                                                            <span>${p.user_id}</span>
                                                            <p>${p.user_id} left 30 mins ago</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </a>
                ...
                <div class="col-md-8 col-xl-6 chat" >
                    <div class="card">
                        <div class="card-header msg_head">
                            <div class="d-flex bd-highlight">
                                <div class="img_cont" >
                                    ...
                                    <a href="playerdetail?player_id=${user.user_id}">
                                        <img src="${user.link_image}" class="rounded-circle user_img" >
                                        <span class="online_icon"></span>
                                    </a>
                                </div>
                            ...
                            <div class="action_menu">
                                <ul>
                                    <a href="playerdetail?player_id=${user.user_id}"><li><i class="fas fa-user-circle"></i> View profile</li></a>
                                    <li><i class="fas fa-users"></i> Add to close friends</li>
                                    <li><i class="fas fa-plus"></i> Add to group</li>
                                    <li><i class="fas fa-ban"></i> Block</li>
                                    <li><a href="deletemessage?player_id=${user.user_id}" onclick="deleteMessage(${user.user_id})"><i class="fas fa-trash"></i> Delete</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <c:forEach items="${historyMessage}" var = "m">
                                ...
                                <c:if test="${m.status eq '0'}">
                                    <div class="d-flex justify-content-end mb-4">
                                        ...
                                        <div class="img_cont_msg">
                                            <img src="${account.link_image}" class="rounded-circle user_img_msg">
                                        </div>
                                    </div>
                                </c:if>
                            </c:forEach>            
                        ...
                        <form action="chat2" method="post"  id="myForm">
                            <input type="text" value="${user.user_id}" name="user_id" class="hidden-input">
