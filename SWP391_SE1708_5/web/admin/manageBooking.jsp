<%-- 
    ...
    Created on : Jul 22, 2023, 1:54:19 AM
    Author     : Cuthi
--%>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-12" style="width: 3000px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span>Total Booking: ${totalBooking}</span></br></br>
                                        <c:if test="${totalBooking == 0}">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${bookings}" var="r">
                                                <tr>
                                                    <td>${r.getPlayerId()}</td>
                                                    <td>${r.getUserId()}</td>
                                                    <td>${r.getTotal_hour()}</td>
                                                    <td>${r.getTotal_price()}</td>
                                                    <td>${r.getDate_booking()}</td>
                                                    <td>${r.getMessage()}</td>
                                                    <td>${r.getStatus()}</td>
                                                </tr>
                                            </c:forEach>
