...
update booking set total_hour = '2' where user_id = 'duongdd123'and  total_price ='124124';
select * from booking;
...
update booking set message = 'Hi bạn, nhóm mình cần 1 bạn nữ cute đáng yêu chơi game cùng trong ngày Chủ Nhật tới.
 Nếu cậu rảnh có thể tham gia chơi cùng bọn mình không nhỉ. Mình thấy cậu rất dễ thương.' where user_id = 'duongdd123'and  total_hour ='2';
select * from booking;
