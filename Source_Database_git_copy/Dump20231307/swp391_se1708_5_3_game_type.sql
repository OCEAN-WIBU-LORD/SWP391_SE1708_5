...
CREATE TABLE `game_type` (
  ...
  `game_type` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `status` tinyint DEFAULT NULL,
  PRIMARY KEY (`game_type`),
  KEY `fk_game_type_game_id` (`game_id`)
...
INSERT INTO `game_type` VALUES ('10','Action-adventure',1),('1','Adventure',1),('2','Candy Crush',1),('3','Fighting games',1),('11','MOBA',1),('4','Puzzle',1),('9','RTS',1),('5','Shooter',1),('6','Simulator',1),('8','Sport',1),('7','Strategy',1);
