...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_details` (`user_id`),
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`player_id`) REFERENCES `player` (`player_id`)
...
-- Dump completed on 2023-07-13 18:19:56
